...
def main():
    ...
    print("\n=== INTAKE OUTPUT ===\n")
    print(f"Product name: {intake.product_name}\n")

    print("Key features:")
    for i, feature in enumerate(intake.key_features, start=1):
        print(f"{i}. {feature}")

    print("\nImage paths:")
    if intake.image_paths:
        for path in intake.image_paths:
            print(f"- {path}")
    else:
